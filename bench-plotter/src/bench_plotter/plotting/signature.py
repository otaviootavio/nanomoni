"""Signature payment mode specific plotting functions."""

from .dashboard_processor import process_dashboard


def process_signature_dashboard(
    test_intervals_path: str,
    output_dir: str = "plots",
    num_points: int = 100,
) -> None:
    """
    Process signature payment mode dashboard queries and test intervals to generate plots.
    ...
    # Get signature-specific panels
    panels_spec = get_dashboard_panels(mode="signature")
    
    # Process with signature panels
    process_dashboard(
