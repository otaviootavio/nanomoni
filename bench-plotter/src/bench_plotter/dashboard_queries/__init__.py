...
def get_dashboard_panels(mode: str = "all"):
    """
    ...
    if mode == "signature":
        ...
        return common_panels + get_signature_panels() + get_payword_panels() + get_paytree_panels()
    else:
        raise ValueError(f"Unknown mode: {mode}. Use 'signature', 'payword', 'paytree', or 'all'")
