...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Generate paytree payment mode plots from dashboard queries and test intervals"
    )
    parser.add_argument(
        "intervals",
        nargs="?",
    ...
    print("Processing paytree payment mode")
    ...
    print(f"Paytree plots generated successfully in '{output_dir}' directory!")
