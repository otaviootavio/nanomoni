...
from bench_plotter.generate_plots.common import (
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Generate signature payment mode plots from dashboard queries and test intervals"
    )
    parser.add_argument(
        "intervals",
        nargs="?",
    ...
    print("Processing signature payment mode")
    ...
    print(f"Signature plots generated successfully in '{output_dir}' directory!")
