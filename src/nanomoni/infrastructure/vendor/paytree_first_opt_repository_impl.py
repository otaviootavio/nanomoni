"""PayTree First Opt repository implementation."""
...
class PaytreeFirstOptRepositoryImpl(
    PaymentChannelRepositoryBaseImpl, PaytreeFirstOptRepository
):
    """KeyValueStore implementation for PayTree First Opt payment channels."""

    async def get_paytree_first_opt_state(
        self, channel_id: str
    ) -> Optional[PaytreeFirstOptState]:
        key_name = f"paytree_first_opt_state:latest:{channel_id}"
    ...
    async def get_paytree_first_opt_channel_state_and_sibling_cache(
        ...
        *,
        ...
        hash_key = _paytree_first_opt_hash_key(channel_id)
    ...
    async def save_paytree_first_opt_payment(
        ...
        hash_key = _paytree_first_opt_hash_key(new_state.channel_id)
    ...
    async def save_channel_and_initial_paytree_first_opt_state(
        ...
        hash_key = _paytree_first_opt_hash_key(channel.channel_id)
