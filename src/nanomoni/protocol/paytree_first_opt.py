...
from nanomoni.crypto.merkle_tree import build_merkle_proof_indexes_for_leaf_a_given_ancestor_b
...
def proof_indexes_first_opt(
    ...
    """
    k_max = max(
        (lca_between(leaf_index, a, depth) for a in prior_leaves), default=-1
    )
