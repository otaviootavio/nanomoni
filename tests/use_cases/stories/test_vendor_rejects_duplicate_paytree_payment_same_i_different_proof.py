"""Story: Vendor rejects duplicate PayTree payment (same i, different proof) (use case-based test)."""
...
async def test_vendor_rejects_duplicate_paytree_payment_same_i_different_proof(
    ...
    await vendor_client.receive_paytree_std_payment(
    ...
    resp = await vendor_client.receive_paytree_std_payment_raw(
