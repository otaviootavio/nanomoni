"""Story: Complete PayTree (Merkle tree) payment channel flow - all actors succeed."""
...
async def test_complete_paytree_flow_all_actors_succeed(
    ...
    for i in indices:
        ...
        resp = await vendor_client.receive_paytree_std_payment(
    ...
    await vendor_client.request_channel_settlement_paytree_std(channel_id)
    ...
    channel_state = await issuer_client.get_paytree_std_channel(channel_id)
